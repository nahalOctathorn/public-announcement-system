...
//   apiRequest<Device>(`${Audios_API_PATH}/${creatorId}`, "POST", data);

// export const updateDevice = (params: Id) => (data: DeviceData) =>
//   apiRequest<MessageResponse>(
//     `${Audios_API_PATH}/${params.id}`,
//     "PATCH",
//     data
//   );
...
//   if (params.id === -1) {
//     apiPath = `${Audios_API_PATH}/device_details`;
//   } else apiPath = `${Audios_API_PATH}/${params.id}/device_details`;
...
//   apiRequest<void>(
//     `${Audios_API_PATH}/${id}/device_details/${deviceDetailId}`,
//     "DELETE"
//   );
