...
//   apiRequest<Device>(`${ANNOUNCEMENTS_API_PATH}/${creatorId}`, "POST", data);

// export const updateDevice = (params: Id) => (data: DeviceData) =>
//   apiRequest<MessageResponse>(
//     `${ANNOUNCEMENTS_API_PATH}/${params.id}`,
//     "PATCH",
//     data
//   );
...
export const fetchAnnouncements = (
    ...
    let apiPath = `${ANNOUNCEMENTS_API_PATH}`;
...
//   if (params.id === -1) {
//     apiPath = `${ANNOUNCEMENTS_API_PATH}/device_details`;
//   } else apiPath = `${ANNOUNCEMENTS_API_PATH}/${params.id}/device_details`;
...
//   apiRequest<void>(
//     `${ANNOUNCEMENTS_API_PATH}/${id}/device_details/${deviceDetailId}`,
//     "DELETE"
//   );
